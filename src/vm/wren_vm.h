...
struct WrenVM
{
  ...
  // The interrupt hook, or NULL (wrenSetInterruptHook). [interruptCountdown]
  // counts loop iterations and calls down to the next call of it.
  WrenInterruptFn interruptHook;
